...
欢迎大家来到《开源软件通识》这门课程，本发刊语将为所有感兴趣的学员介绍，在接下来的一个学期中，我们将要接触到的开源软件那些事，本文也从课程背景、课程体系、课程进程、学习模式、学习评价、拓展大赛等几个方面，详细介绍下这门课程，带你一起畅游开源软件的世界。
...
**拓展大赛**
《开源软件通识》课程同时和今年的“OpenDigger 开源软件生态数据分析挖掘平台全球大赛”（由开放原子与开源社共同举办）充分结合，课程作为大赛的标准配套培训课，供参赛选手进行学习；同时线下班的期末大作业也择优选取，作为大赛作品的推荐。本次大赛共一等奖 1 名，二等奖 4 名，三等奖 8 名，OpenRank 影响力奖 50 名，奖金池总共 50 万元。
整个大赛的日程，以及与课程适配的时间安排如下。
